...
<template>
	<div class="policy-page overflow-auto bg-black text-white p-8 font-sans">
		<h2 class="text-xl font-bold mb-4">Política de Privacidade</h2>

		<div class="space-y-4 text-sm leading-relaxed">
			<p>A sua privacidade é importante para nós. É política da Editora Afirmativa respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Editora Afirmativa, e outros sites que possuímos e operamos.</p>
			...
			<h3 class="text-lg font-bold pt-4">Mais informações</h3>

			<p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>

			<p>Esta política é efetiva a partir de 10 Abril 2023 20:20</p>
		</div>
	</div>
</template>
